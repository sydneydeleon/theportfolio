...
import Mock from './images/hairsalonv1.png';
import './Mockups.css';

function ProjSalonTwo() {
    return (
        <>
        ...
        <div className="portfolio-works-mockup-desc"> 
            Nichole D'andrea is a local cosmetologist in the Valley. She had everything she needed to be successful in her own business: the talent, the creativity, and the drive. All she needed was a website to put it altogether. That's where I came in! I put together two mock ups for potential designs. This is <i>version two</i>.
            </div>
